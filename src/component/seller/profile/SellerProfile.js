    ...
    <>
        ...
        <div className="grid grid-cols-12 ">
            ...
            <div className="hidden lg:block md:col-span-2  lg:col-span-2 ">
              <MainCategory style="w-[160px]"/>
            </div>
            
            <div class="col-span-3 md:col-span-4 lg:col-span-4  ">
              {/* flex justify-start xxl:justify-end */}
              <div className='pt-[0px] rounded-lg  flex  justify-center content-center'>
              ...
              <div>
                {/* // Shop Name */}
                <h1 className='ml-[80px] mt-3'>XYZ Shop</h1>
                {/* // offline Shop Address Logo And Details  */}
                <div className='flex '>
                    <MdOutlineLocationCity  className='ml-[80px] mt-1 mr-2'/>
                    <h1>location Details</h1> 
                    </div>
                    
                    {/* // google map link Logo And Details  */}
                    <div className='flex'>
                    <FaMapLocationDot className='ml-[80px]  mt-1 mr-2'/>
                      Click this link 
